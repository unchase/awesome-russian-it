...
> Список русскоязычных подкастов для инженеров и разработчиков сферы ИТ. Здесь собрана информация обо всех наиболее популярных ресурсах, где размещен подкаст, а также указаны ссылки для связи с авторами подкастов.
