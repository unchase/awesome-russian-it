...
Я понимаю, что не все авторы хотели бы, чтобы ссылки на их соц. сети были доступны в одном месте, и готов убрать (или изменить) указанные контакты по первому запросу автора. Их размещение не несёт какого-либо злого умысла.
